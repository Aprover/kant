 ...
 */
type Nonce, SymmetricKey, PrivateKey, PublicKey , Group, IdCertificate, BitString, Timestamp, Digest , Tag , Signature, Ciphertext, Number 

metadata aes_128_cbc, aes_256_cbc 
