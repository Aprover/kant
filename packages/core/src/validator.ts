import { type MaybePromise, type ValidationAcceptor, type ValidationChecks } from "langium"
import { Protocol, type KantAstType } from "./generated/ast"
...
export const KantValidator = {
    knowledgeRetrieval: (protocol: Protocol, accept: ValidationAcceptor) => {
    ...
    sameFunctionDefSecondaryParamNumber: (protocol: Protocol, accept: ValidationAcceptor): MaybePromise<void> => {
        sameFunctionDefSecondaryParamCardinality.sameFunctionDefSecondaryParamCardinality(
            globalDescription,
            protocol,
            accept
        )
    ...
    correctFunctionInvocationSecondaryParams: (protocol: Protocol, accept: ValidationAcceptor): MaybePromise<void> => {
        correctFunctionInvocationSecondaryParams.correctFunctionInvocationSecondaryParams(
            globalDescription,
            protocol,
            accept
        )
