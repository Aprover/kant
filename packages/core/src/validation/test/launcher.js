            ...
            _loop_1 = function (file) {
                ...
                if (fileStats.isDirectory()) {
                    ...
                    ;(0, child_process_1.exec)(
                        "npm run cli check packages/core/src/validation/test/test-cases/".concat(file),
                            ...
                            if (error) {
                                if (stderr) {
                                    console.log(
                                        "\u001B[32m%s\u001B[0m",
                                        "["
                                            .concat(counter, "] Test for ")
                                            .concat(file, ": SUCCESSFUL. The output includes the desired error.")
                                    )
                                    counter++
                                }
                                return
                                ...
                                console.log(
                                    "\u001B[31m%s\u001B[0m",
                                    "[".concat(counter, "]Test for ").concat(file, ": FAILED.\n").concat(error)
                                )
                                counter++
                                return
                            }
